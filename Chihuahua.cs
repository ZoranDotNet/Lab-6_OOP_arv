namespace OOP_arv
{
    class Chihuahua : Dog
    {
        ...
        //Constructor
        public Chihuahua(string name, int age, string color, string food, bool wild, string likesToDo, string sound, string placeToSleep, string breed, string badHabit, string sound2)
        ...
        public Chihuahua()
        {
            Name = "Carlos"; Age = 2; Color = "light brown"; Food = "can food"; Wild = false; LikesToDo = "bark at strangers"; PlaceToSleep = "the couch";
        }
        ...
        public override void Print()
        {
            Console.WriteLine($"{Name}, {Breed}, {Age}, {Color}, {Food}, likes to {LikesToDo}, " +
                $"Is wild: {Wild}, Badhabit: {BadHabit}");
        }
